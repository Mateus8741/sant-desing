...
export function Section5() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-8 text-white my-24">
      <h2 className="font-bold text-4xl sm:text-6xl md:text-8xl text-center">
        Vamos conversar?
      </h2>
      ...
      <div className="relative inline-block">
        ...
        />
        <motion.button
          className="relative w-[13rem] sm:w-52 h-16 bg-white text-black font-bold rounded-full hover:bg-[#57EB9B] transition duration-300 ease-in-out"
          onClick={handleClick}
        >
          Whatsapp
        </motion.button>
